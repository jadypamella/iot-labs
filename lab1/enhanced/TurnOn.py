# IoTLab1/enhanced/TurnOn.py
# -*- coding: utf-8 -*-
#!/usr/bin/env python

"""
Turns on a device by its NAME.
Usage:
  python TurnOn.py "device-name"
"""
...
def main():
    if len(sys.argv) < 2:
        print('Usage: python TurnOn.py "device-name"')
        sys.exit(2)
    name = sys.argv[1]
    ...
    try:
        ...
        r = requests.get(
            "https://pa-api.telldus.com/json/device/turnOn",
